#
#  Be sure to run `pod spec lint RxSkeleton.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Emiya Shiro" => "code4archer@163.com" }
  # Or just: spec.author    = "Emiya Shiro"
  # spec.authors            = { "Emiya Shiro" => "email@address.com" }
  # spec.social_media_url   = "https://twitter.com/Emiya Shiro"
